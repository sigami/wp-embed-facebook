		...
		switch ($fb_post["type"]) :
			...
			case 'photo':
				...
				<div class="wef-hovereffect">
					...
					<div class="overlay">
						<a class="info" href="<?php echo $fb_post['full_picture'] ?>" <?php echo WP_Embed_FB_Plugin::get_option('lightbox_att') ?>><br></a>
					</div>
				</div>
				<?php echo $link_info; ?>
				<?php
			...
			default:
				...
				<div class="wef-hovereffect">
					...
					<div class="overlay">
						<a class="info" href="<?php echo $fb_post['full_picture'] ?>" <?php echo Plugin::get_option('lightbox_att') ?>><br></a>
					</div>
				</div>
				<?php endif; ?>
				<?php echo $link_info; ?>
